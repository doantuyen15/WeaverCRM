...
export function NotificationDialog({ open, handleOpen, title = 'Notification', message = '', handleCallback }) {
    return (
        <Dialog className="z-[999999]" size="sm" open={open} handler={() => handleCallback(false)}>
